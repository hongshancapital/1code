...
## Purpose
**Hong Cowork** - A local-first Electron desktop app for AI-powered code assistance. Users create chat sessions linked to local project folders, interact with Claude in Plan or Agent mode, and see real-time tool execution (bash, file edits, web search, etc.).
...
- **Hong CDN**: Auto-update manifests and releases at `cowork.hongshan.com`
