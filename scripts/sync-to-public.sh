...
# Sync desktop app to public hong repository
...
PUBLIC_REPO="git@github.com:21st-dev/hong.git"
PUBLIC_REPO_HTTPS="https://github.com/21st-dev/hong"
PRIVATE_REPO="21st-dev/21st"
TEMP_DIR="/tmp/hong-sync-$$"
...
if [ -z "$RELEASE_NOTES" ]; then
    ...
    echo "   gh release create $TAG --title \"Hong $TAG\" --notes \"...\""
    echo ""
