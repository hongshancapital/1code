 ...
 * Supports legacy (~/.hong/worktrees/{projectId}/{chatId}/) and
 * new format (~/.hong/worktrees/{projectName}/{worktreeFolder}/).
 *
...
export function resolveProjectPathFromWorktree(
  ...
  const worktreeMarker = path.join(".hong", "worktrees")
  ...
  try {
    ...
    // Path format: /Users/.../.hong/worktrees/{projectSlug}/{worktreeFolder}
    const worktreeBase = path.join(os.homedir(), ".hong", "worktrees")
