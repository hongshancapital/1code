...
// Both dev and production use 3010 (Okta only allows one callback URL configured)
// TODO: Configure separate Okta app for dev if needed, then change to: IS_DEV ? 3310 : 3010
export const OKTA_CALLBACK_PORT = 3010
