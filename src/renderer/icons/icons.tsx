...
// Tools icon - wrench (settings/tools)
...
// Tools icon filled - wrench filled version
export function ToolsIconFilled(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
// LiteLLM icon - stylized "L" with connected nodes representing model proxy
export function LiteLLMIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <path d="M7 4C7 3.44772 7.44772 3 8 3C8.55228 3 9 3.44772 9 4V17H16C16.5523 17 17 17.4477 17 18C17 18.5523 16.5523 19 16 19H8C7.44772 19 7 18.5523 7 18V4Z" />
      <circle cx="17" cy="7" r="2.5" />
      <circle cx="17" cy="13" r="2.5" />
      <path d="M9 7H14.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
      <path d="M9 13H14.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
    </svg>
  )
}
