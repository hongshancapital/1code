...
import { FilesIcon, SkillIcon, CustomAgentIcon, OriginalMCPIcon } from "../../../icons/icons"
...
function MentionChip({ mention }: { mention: ParsedMention }) {
  ...
  return (
    ...
    >
      <Icon className={mention.type === "tool" ? "h-3.5 w-3.5 text-muted-foreground shrink-0" : "h-3 w-3 text-muted-foreground shrink-0"} />
