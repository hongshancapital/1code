...
2. Create the file .hong/worktree.json with setup commands
...
Example output for .hong/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .hong/worktree.json with the appropriate setup commands.`,
}
